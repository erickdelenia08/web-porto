...
const AboutSection = () => {
  ...
  //     ease: "none",
  //    scrollTrigger: {
  //       trigger: sectionRef.current, // Elemen yang memicu animasi
  //       pin: true,                    // Kunci layar secara vertikal
  //       scrub: 1,                     // Animasi mengikuti gerakan scroll (angka 1 bikin efek smooth)
  //       // start: "top top",          // Dimulai ketika bagian atas trigger menyentuh atas layar
  //       end: () => `+=${sectionRef.current.offsetWidth}`, // Durasi scroll sepanjang konten horizontal
  //     }
  //   })
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 flex gap-4"
    >
                ...
                <div className="grid grid-cols-2 gap-6 mt-8">
                  <Card className="text-center p-6 bg-gradient-to-br from-[#00b4d8]/5 to-[#0077b6]/5 border-[#00b4d8]/20">
                    <CardContent className="p-0">
                      <div className="text-2xl font-bold text-[#00b4d8] mb-2 gs-num">4+</div>
