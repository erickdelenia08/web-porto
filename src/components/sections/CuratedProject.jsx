...
const projectData = [
  {
    ...
    description: 'Platform jual beli produk digital dengan alur checkout instan dan animasi interaktif.',
  ...
  },
  {
    ...
    description: 'Aplikasi pengelolaan tugas & keuangan personal dengan integrasi REST API.',
    tags: ['Flutter', 'Dart', 'REST API', 'Provider'],
    image: '/img3.png',
  },
  {
    id: 3,
    title: 'MOTION VISUAL SHOWCASE',
    category: 'MOTION DESIGN',
    description: 'Eksplorasi animasi UI, mikro-interaksi, dan 3D visual loop untuk brand digital.',
    tags: ['After Effects', 'GSAP', 'Lottie', 'C4D'],
    image: '/img3.png',
  },
  {
    id: 4,
